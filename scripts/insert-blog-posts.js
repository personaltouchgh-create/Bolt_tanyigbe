...
const supabaseUrl = 'https://wsohhifdbjmflmpdzpxp.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indzb2hoaWZkYmptZmxtcGR6cHhwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAwNzUwNDYsImV4cCI6MjA4NTY1MTA0Nn0.jzyQE4jaM2gnugkwasrAe2BdeGNs0TR8cAMcgGUt8tI';
...
async function insertPosts() {
  ...
  console.log('\n✓ All blog posts have been inserted successfully!');
}
