...
-- Create policy for public to view published posts
...
-- Clear any existing sample posts (optional - remove this line if you want to keep existing posts)
...
SELECT '✓ Blog setup complete! 8 sample posts have been added.' as status;
