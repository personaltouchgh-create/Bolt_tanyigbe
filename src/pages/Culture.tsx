  ...
  return (
    <div>
      <section className="relative h-96 flex items-center justify-center bg-cover bg-center"
        style={{ backgroundImage: 'url(https://placehold.co/1920x600/FF4516/FFF?text=Our+Culture)' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#E2A201] bg-opacity-10 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li><span className="font-semibold">Woezɔ na mi:</span> Welcome (plural)</li>
                  <li><span className="font-semibold">Ŋdi na wò:</span> Good morning</li>
                  <li><span className="font-semibold">Fiẽyi na wò:</span> Good afternoon</li>
