        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="relative h-80 bg-gradient-to-br from-[#FF4516] to-[#E2A201] flex items-center justify-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="relative h-80 bg-gradient-to-br from-[#E2A201] to-[#FF4516] flex items-center justify-center">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {communities.map((community, index) => (
                  <div key={index} className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-sm">
                    <div className="w-3 h-3 rounded-full bg-[#FF4516]"></div>
