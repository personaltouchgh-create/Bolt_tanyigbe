        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              Tanyigbe-Anyigbe is one of the four divisions of the Tanyigbe Traditional Area, with a rich history and vibrant cultural heritage. The division is home to several communities united under traditional governance.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="relative h-80 bg-gradient-to-br from-[#E2A201] to-[#4C7000] flex items-center justify-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="relative h-80 bg-gradient-to-br from-[#4C7000] to-[#E2A201] flex items-center justify-center">
              ...
              <div className="p-8">
                ...
                <p className="text-[#4C7000] font-semibold mb-4">Queenmother of Tanyigbe-Anyigbe</p>
                <p className="text-gray-700 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 mb-12 text-center">
              Communities Under Tanyigbe-Anyigbe
            </h2>

            <div className="bg-gradient-to-r from-[#E2A201]/10 to-[#4C7000]/10 rounded-2xl p-8 mb-8">
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                The Tanyigbe-Anyigbe division comprises several communities, each with its own unique character while united under shared traditions and governance.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                {communities.map((community, index) => (
                  <div key={index} className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-sm">
                    <div className="w-3 h-3 rounded-full bg-[#E2A201]"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-200 leading-relaxed mb-8">
              Tanyigbe-Anyigbe continues to play a vital role in preserving and promoting the cultural heritage of the Tanyigbe Traditional Area.
            </p>
            <Link
              to="/culture/tayafest"
